		...
		public function redirect()
			{
				...
				//Redirect
				if ($this->error)
					header("Location: curriculo.php?status=erro");
				else
					header("Location: curriculo.php?status=sucesso");
				die();
			}
...
$curriculo = new alterarCurriculo();