 ...
 *
 */
class ProcSelFlexiGridFunctions
	{
		private $procSel;
		private $action;
		...
		public function getList()
			{
				...
				$data = $this->procSel->getFlexiGridData($query, $qType, $letterPressed, $page, $rp, $sortName, $sortOrder, $_POST);
...
if($session->loggedIn)
	$procSelFlexiGrid = new ProcSelFlexiGridFunctions();