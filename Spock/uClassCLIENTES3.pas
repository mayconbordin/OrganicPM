...
procedure TuClassCLIENTES.SetFID_CLIENTE(const Value: string);
begin
  FID_CLIENTE := Value;
end; 
procedure TuClassCLIENTES.SetFNOME(const Value: string);
begin
  FNOME := Value;
end; 
procedure TuClassCLIENTES.SetFDATA_NASC(const Value: string);
begin
  FDATA_NASC := Value;
end; 
